...
"[برای مشاهده پادکست مربوطه کلیک کنید](https://t.me/studentsbme/6)\n\n"
...
"[برای مشاهده پادکست مربوطه کلیک کنید](https://t.me/studentsbme/189)\n\n"
...
"[9.اپلای چیست؟ مدارک مورد نیاز آن چیست؟کدام کشور ها برای اپلای یک مهندس پزشک شرایط بهتری دارند؟]()\n\n"


"[10. چه دانشگاه‌ها و مراکز آموزشی در ایران رشته مهندسی پزشکی ارائه می‌دهند؟](https://t.me/studentsbme/82)\n\n\n"
...
async def Button_click(update:Update , context:ContextTypes.DEFAULT_TYPE) :
    ...
    #     ]
        ...
        user_id =update.message.from_user.id
        if user_id not in int(ADMIN_CHAT_ID):
            # print(user_id,ADMIN)
