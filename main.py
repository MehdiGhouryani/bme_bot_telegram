...
"[11. چه منابعی برای مطالعه و آموزشی فراتر از دانشگاه در رشته مهندسی پزشکی وجود دارد؟]()\n" 
"(کتاب، مقاله، وبسایت، دوره‌های آموزشی)\n\n"

"[12.اپلای چیست؟ مدارک مورد نیاز آن چیست؟کدام کشور ها برای اپلای یک مهندس پزشک شرایط بهتری دارند؟]()\n\n"

"[13. آیا برای ادامه و موفقیت در این رشته نیاز به تحصیل در مقاطع ارشد و دکترا هست؟]()\n\n"

"[14. چه چالش‌ها و فرصت‌هایی برای تکامل آینده و تلفیق آن برای مهندسین پزشکی وجود خواهد داشت؟]()\n\n"


"[15. استخدام های دولتی رشته مهندسی پزشکی چگونه است؟ (شرایط و نحوه گزینش)]\n\n"

"[16.کار آموزی در شرکت یا بیمارستان بهتر است؟چرا؟]()\n\n"

"[17. عضویت در انجمن متخصصین تجهیزات پزشکی کشور چگونه است؟]()\n\n"

"[18.مهندس پزشک در بیمارستان چه چالش هایی دارد؟]()\n\n"

"[19.طرح چیست؟ نحوه ثبت نام و شرایطش چگونه است؟]()\n\n"

"[20.مقاله نویسی چیست؟ میزان اهمیت ان برای اپلای و رزومه چگونه است؟]()\n\n\n"
...
async def Button_click(update:Update , context:ContextTypes.DEFAULT_TYPE) :
    ...
    #     ]
        ...
        await update.message.reply_text(text=question_page1,parse_mode=ParseMode.MARKDOWN,reply_markup=ReplyKeyboardMarkup(InlineKeyboardButton('⬅️ برو به صفحه بعد ',callback_data='next_question')))
...
async def callback_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data in combined_callback_map:
      await combined_callback_map[data](data,update, context)
        ...
        await update.message.reply_text(text=question_page2,parse_mode=ParseMode.MARKDOWN,reply_markup=ReplyKeyboardMarkup(InlineKeyboardButton('⬅️ برو به صفحه قبل ',callback_data='previous_question')))
